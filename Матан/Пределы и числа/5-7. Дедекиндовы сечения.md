...
$\exists\varepsilon>0:\forall N\exists\ n>N:|a_{n}-a_{n}'|>\varepsilon$

для бесконечно многих номеров, либо $a_{n}-a_{n}'>\varepsilon$ либо $a_{n}'-a_{n}>\varepsilon$

Пусть для бесконечно многих номеров $a_{n}-a_{n}'>\varepsilon$

$\exists n_{\varepsilon}:\forall n>n_{\varepsilon}$ длина $[a_{n}',b_{n}']< \frac{{\varepsilon}}{2}$
...
1. Совпадение левых классов
	   - $r\inЛЕВЫЙ\ КЛАСС\ ДЛЯ\ \{I_{n}\}$
	     $\exists n_{i}:r<a_{n}$
	     $\exists n_{\varepsilon}:\forall n>n_{\varepsilon} \ \ \ \  |a_{n}-a_{n}'|< \frac{\varepsilon}{2} \implies$
...
### ОПР $\varepsilon$-окрестность

$\forall\varepsilon>0:(x-\varepsilon,x+\varepsilon)$ — $\varepsilon$-окрестность числа $x$
...
$x_{n}\to x_{1}$, если $\forall\varepsilon>0\ \exists n_{\varepsilon}:\forall n>n_{\varepsilon}:|x_{n}-x|<\varepsilon$
...
## Теорема полнота по Вейерштрассу следует из полноты по кантору
