...
$\exists\varepsilon>0:\forall N \exists n>N:|x_{n}-a|>\varepsilon$
...
####	Доква  
$\forall\varepsilon>0\exists N_{1}:\forall_{n}>N_{1}|x_{n}-a|< \frac{\varepsilon}{2}$
$\forall\varepsilon>0\exists N_{2}:\forall_{n}>N_{2}|y_{n}-b|< \frac{\varepsilon}{2}$
$\forall\varepsilon>0\exists N:\forall{n}>N|x_{n}+y_{n}-(a+b)|<\varepsilon$ 

$N=max\{N_{1},N_{2}\}$
$|x+y|\leq |x|+|y|$

$|x_{n}-a+y_{n}-b|\leq |x_{n}-a|+|y_{n}-b|< \frac{\varepsilon}{2} + \frac{\varepsilon}{2}= \varepsilon$
