...
##### 2 $A\cap B=\emptyset\ \forall a\in A,\forall b\in B$
...
$[a_{1}, b_{1}]\supset[a_{2}, b_{2}]\supset\dots \supset[a_{n}, b_{n}]\supset[a_{n+1}, b_{n+1}]\supset\dots$
$\forall n, a_{n}<b_{n}\exists c\in \mathbb{R},c\in[a_{n},b_{n}]$
